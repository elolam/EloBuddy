...
namespace Kayle
{
    internal class Program
    {
        ...
        private static void Ultimate()
        {
            ...
            {
                if (useR2 && !Player.Instance.IsInShopRange() && R.IsReady() && (!Player.Instance.IsRecalling()) && (target2.Position.CountEnemyChampionsInRange(R.Range) >= 1 || Tru(target2.Position)))
                {
